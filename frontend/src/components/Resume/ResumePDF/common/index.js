...
export const ResumePDFText = ({ bold = false, themeColor, style = {}, children }) => {
  return (
    <Text
      style={{
...
export const ResumePDFLink = ({ src, isPDF, children }) => {
  if (isPDF) {
    return (
...
export const ResumeFeaturedSkill = ({ skill, rating, themeColor, style = {} }) => {
  const numCircles = 5;
